        ...
        <form id="addTaskForm">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <textarea id="editor" placeholder="Enter task details"></textarea>
                </div>
            </div>
            ...
            <div class="form-row" style="display: flex; justify-content: space-between;">
                <div class="form-group" style="flex: 1; margin-right: 10px;">
                    ...
                    <input type="date" id="date" name="date" class="custom-input" style="height:36px;" required>
                </div>
                <div class="form-group" style="flex: 1;">
                    <label for="priority" class="form-label">Priority</label>
                    <select id="priority" name="priority" class="custom-input" required>
            ...
            <div class="form-row" style="display: flex; justify-content: space-between; margin-top: 10px;">
                <div class="form-group" style="flex: 1; margin-right: 10px;">
                    ...
                    <select id="assign" name="assign" class="custom-input" required>
